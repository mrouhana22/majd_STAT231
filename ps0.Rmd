...
author: "Majd Rouhana"
date: "due by 5 PM on Thursday, August 27"
output:
...
> RESPONSE: The `datasaurus_dozen` file contains 1846 rows and 3 columns. The variables included are dataset, x, and y.
...
> RESPONSE: The correlation coefficient is about -0.064. This correlation implies that the relationship between `x` and `y` is relatively weak.
...
> RESPONSE: There seems to be a very weak relationship between x and y. The graph makes the shape of a dinosaur head too.
...
> RESPONSE: The correlation coefficient is about -0.062. There seems to be a weak relationship between x and y. This correlation coefficient is very similar to the one in the `dino` dataset.
...
> RESPONSE: The plot does not look the same. This plot looks like a star.
...
> RESPONSE: The correlation coefficient is about -0.068. There seems to be a weak relationship between x and y. This correlation coefficient is very similar to the other two datasets.
...
> RESPONSE: The plot does not look the same. This plot looks like a circle.
...
> RESPONSE: The plots of all the datasets make a shape. The correlation coefficients for each of these datasets are about -0.06, indicating a weak relationship. Since the datasets don't seem to have much of a relationship, as the points seem chosen specifically to make a shape, I would say that the correlation coefficients seem appropriate.
