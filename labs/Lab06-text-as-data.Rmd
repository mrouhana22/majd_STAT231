...
path_in <- "/home/class22/mrouhana22/git/majd_STAT231/labs"
...
> ANSWER: This is because `tfidf` decreases the weight of commonly used words--many of which are the stop words.
...
> ANSWER: "Slick" has a score of 2, implying a positive connotation. I don't think the word always has a positive connotation, though. If you say someone is slick, it could also mean they're something like a con-artist.
...
> ANSWER: Each row is a word followed by the specific sentiment it implies. Words that contain multiple sentiments are on separate rows.
...
> ANSWER: Yes, because the usage of words changes throughout time and sometimes it's hard to tell the sentiment of a word without reading it in context.

- The lexicons are based on unigrams.  Do you see any disadvantages of basing the sentiment on single words?

> ANSWER: Yes, because a lot of the time you can negate words by adding other words. For example, "wonderful" has a score of 4, but if someone said "my day was definitely not wonderful," the sentence has a negative connotation.
...
> ANSWER: Some words are "day," "thee" and "tis." The NRC lexicon misses 7961 words from Dickinson poems. 55% of all the words that appear in Dickinson poems. The lexicon itself only contains 6468 unique words. There are 120% more words missed in the Dickinson poems than the lexicon itself contains.
