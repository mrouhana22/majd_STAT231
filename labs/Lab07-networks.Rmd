...
mig_easteurp <- ggnetwork(MigrationEastEurp)

ggplot(data = mig_easteurp, aes(x = x, y = y, xend = xend, yend = yend)) +
...
> ANSWER: Color, because it's easier to tell between different colors than different sizes.

Might the color scheme in the plot below be more effective?

> ANSWER: Yes, if the colors were more distinct. (Rainbow)
...
> ANSWER: Check sentences to see if they have two names, and verbs that imply interaction between them. For example, "Aemon speaks to Grenn." We can count the occurrences of this happening.
