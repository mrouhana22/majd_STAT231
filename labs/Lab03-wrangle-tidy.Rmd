...
> RESPONSE: We need the variables of spending that include the total costs for each year and the employer coverage variable for each year. The rows in the dataset represent each state in the US.
