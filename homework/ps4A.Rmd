...
> ANSWER: Genzebe Dibaba holds the indoor one-mile world record for IAAF women with a time of 4:13.31.
...
> ANSWER: The fastest world record is 4:12.33 by Sifan Hassan. The record is from an outdoor event.

```{r}
women_outdoor <- html_table(tables[[8]])
women_outdoor <- mutate(women_outdoor, Type = "Outdoor")
women_indoor <- mutate(women_indoor, Type = "Indoor", Auto = NA)
